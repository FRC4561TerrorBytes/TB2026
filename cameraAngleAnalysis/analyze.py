...
parser.add_argument("trajectory", help='The ".traj" file to analyze')
parser.add_argument("--layout", default="2026-official.json", help="The AprilTag field layout JSON")
...
# Load trajectory
traj_json = json.loads(open(args.trajectory).read())
last_time = 0
