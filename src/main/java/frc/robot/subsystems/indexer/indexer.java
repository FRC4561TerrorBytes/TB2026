...
public class Indexer extends SubsystemBase {
  ...
  public Indexer(IndexerIO io) {
    ...
    indexerRightDisconnectedAlert =
        new Alert("Indexer Right Freaking Disconnected Bruh", AlertType.kError);
    indexerLeftDisconnectedAlert =
        new Alert("Indexer Left Freaking Disconnected Bruh", AlertType.kError);
    fuelKickerDisconnectedAlert =
        new Alert("Fuel Kicker Freaking Disconnected Bruh", AlertType.kError);
  }
