...
public class Drive extends SubsystemBase {
  ...
  public static final double DRIVE_BASE_RADIUS =
      Math.max(
          Math.max(
              Math.hypot(TunerConstantsOld.FrontLeft.LocationX, TunerConstantsOld.FrontLeft.LocationY),
              Math.hypot(TunerConstantsOld.FrontRight.LocationX, TunerConstantsOld.FrontRight.LocationY)),
          Math.max(
              Math.hypot(TunerConstantsOld.BackLeft.LocationX, TunerConstantsOld.BackLeft.LocationY),
              Math.hypot(TunerConstantsOld.BackRight.LocationX, TunerConstantsOld.BackRight.LocationY)));
  ...
  public static Translation2d[] getModuleTranslations() {
    return new Translation2d[] {
      new Translation2d(TunerConstantsOld.FrontLeft.LocationX, TunerConstantsOld.FrontLeft.LocationY),
      new Translation2d(TunerConstantsOld.FrontRight.LocationX, TunerConstantsOld.FrontRight.LocationY),
      new Translation2d(TunerConstantsOld.BackLeft.LocationX, TunerConstantsOld.BackLeft.LocationY),
      new Translation2d(TunerConstantsOld.BackRight.LocationX, TunerConstantsOld.BackRight.LocationY)
    };
  }
  @AutoLogOutput
